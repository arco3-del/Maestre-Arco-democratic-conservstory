...
const PracticalTest: React.FC<{ onComplete: () => void; error: string | null }> = ({ onComplete, error }) => {
    const practicalTestQuote = "If you feel comfortable, sing or play something. I'm not looking for perfection, just to know your starting point.";
    return (
        <div className="bg-gray-800/50 p-8 rounded-lg border border-gray-700 text-center animate-fade-in">
            ...
            <div className="flex items-start justify-center text-center gap-3 mb-6">
                <AudioPlayerButton getAudioData={() => generateSpeechFromText(practicalTestQuote, 'Kore')} className="flex-shrink-0 mt-1" />
                <p className="text-gray-400 text-left">"{practicalTestQuote}"</p>
            </div>
