...
export const WelcomeScreen: React.FC<{ onComplete: () => void }> = ({ onComplete }) => {
    ...
    const welcomeQuote = "Here, there are no walls to limit your learning, no barriers to silence your artistic voice. I am here to guide you. Shall we begin?";
    ...
    return (
        <section className="relative min-h-screen flex items-center justify-center text-center text-white overflow-hidden">
            ...
            <div className={`relative z-10 container mx-auto px-4 transition-opacity duration-1000 ${visible ? 'opacity-100' : 'opacity-0'}`}>
                ...
                <div className="flex items-start justify-center gap-3 max-w-4xl mx-auto mb-12">
                     <AudioPlayerButton getAudioData={() => generateSpeechFromText(welcomeQuote, 'Kore')} className="flex-shrink-0 mt-1" />
                    <p className="text-lg text-gray-300 text-left">
                        "{welcomeQuote}" - Maestre Arco
                    </p>
                </div>
                <button
                    onClick={onComplete}
